...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.digio.esign_plugin.EsignPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin esign_plugin, com.digio.esign_plugin.EsignPlugin", e);
    }
    try {
